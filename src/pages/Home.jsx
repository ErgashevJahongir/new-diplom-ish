...
const Home = () => {
  ...
  return (
    <div>
      {contextHolder}
      <section className="w-full bg-center bg-cover h-screen bg-[url('src/assets/hero-bg.webp')]">
          ...
          <div className='mt-12 border-t border-gray-100 pt-6'>
            <div className='text-center sm:flex sm:justify-between sm:text-left'>
              <p className='text-sm text-gray-500'>
                ...
                <a className='inline-block ml-2 text-teal-600 underline transition hover:text-teal-600/75' href='/'>
                  Bakhtiyor
                </a>
              </p>

              <p className='mt-4 text-sm text-gray-500 sm:order-first sm:mt-0'>&copy; 2023 Company Name</p>
            </div>
          </div>
        </div>
      </footer>
